...
const CARD_ICONS = {
  whatAreCookies: <CookieIcon className="size-4 shrink-0" />,
  typesOfCookies: <BookIcon className="size-4 shrink-0" />,
  managingCookies: <ScaleIcon className="size-4 shrink-0" />
} as const;

const CARD_KEYS = ['whatAreCookies', 'typesOfCookies', 'managingCookies'] as const;
const ACCORDION_KEYS = ['cookiesWeUse', 'thirdPartyCookies', 'howToManage', 'changes'] as const;
